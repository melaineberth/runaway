...
class ParticlesSpark extends StatefulWidget {
  ...
  @override
  State<ParticlesSpark> createState() => _ParticlesSparkState();
}

class _ParticlesSparkState extends State<ParticlesSpark>
...
class ParticlesSparkPainter extends CustomPainter {
  final List<RisingParticle> particles;

  ParticlesSparkPainter({required this.particles});
  ...
  @override
  bool shouldRepaint(ParticlesSparkPainter oldDelegate) => true;
}
