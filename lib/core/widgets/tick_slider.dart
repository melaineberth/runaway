...
/*──────────────── helpers ────────────────*/
  ...
  double _rubberBand(double x, double limit) {
    final absX = x.abs();
    // Augmente le coefficient pour plus de sensibilité
...
/*──────────────── drag logic ─────────────*/
  ...
  void _endDrag() {
    ...
    _spring
      ..stop()
      ..value = _overscroll;                   // point de départ
    const spring = SpringDescription(
      mass: 0.7, stiffness: 250, damping: 20, // réglage “Apple-like”
    );
        ...
        Expanded(
          child: LayoutBuilder(builder: (ctx, cst) {
            ...
            return GestureDetector(
              ...
              onTapDown:             (d) => _updateDrag(d.localPosition),
              onHorizontalDragStart: (d) => _updateDrag(d.localPosition),
